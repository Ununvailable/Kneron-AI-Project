...
/**
 * @brief To sned command.
 *
 * @param[in] devices a set of devices handle.
 * @param[in] cmd  RMI command.
 * @param[in] cmd_size  write length.
 * @return refer to KP_API_RETURN_CODE in kp_struct.h
 */
...
/**
 * @brief Release the single node output data from raw output buffer
 *
 * @param raw_fixed_node_output kp_inf_raw_fixed_node_output_t to be released
 */
 ...
 * @brief Release the single node output data from raw output buffer
 *
 * @param fixed_node_output kp_inf_fixed_node_output_t to be released
 */
 ...
 * @brief Release the single node output data from raw output buffer
 *
 * @param fixed_node_output kp_inf_float_node_output_t to be released
 */
void kp_release_float_node_output(kp_inf_float_node_output_t *float_node_output);

/**
 * @brief Release the debug checkpoint data
 *
 * @param checkpoint_buf checkpoint buffer to be released
 *
 * @return refer to KP_API_RETURN_CODE in kp_struct.h
 */
