...
static err_str_map _errmap[] = {
    ...
    {KP_FW_ERROR_UNSUPPORT_TOOLCHAIN_VERSION_136, "Device does not support the model under this toolchain version"},
    {KP_FW_ERROR_SET_IE_TIMEOUT_FAIL_137, "Device is not able to set the IE timeout"},
    {KP_FW_ERROR_SET_NPU_TIMEOUT_FAIL_138, "Device is not able to set the NPU timeout"},
    {KP_FW_NCPU_INVALID_IMAGE_201, "NPU cannot handle this image data under current pre-process setting (e.g. Padding > 127)"},
    {KP_FW_NCPU_INPROC_FAILED_202, "NPU execute inproc failed"},
    {KP_FW_NCPU_CPU_OP_NOT_FOUND_203, "Unsupported CPU operation found"},
    {KP_FW_NCPU_MYSTERY_OP_NOT_FOUND_204, "Unsupported Mystery operation found"},
    ...
    {KP_FW_APP_MASK_FDFR_ENROLL_WITH_MASKED_FACE_10000, "Invalid operation - enroll face embedding with masked face for app mask fdfr"},
    {KP_FW_APP_SEG_INSUFFICIENT_RESULT_BUFFER_SIZE_10001, "Insufficient result buffer size for app seg"},
    {KP_FW_APP_STEREO_DEPTH_INSUFFICIENT_RESULT_BUFFER_SIZE_10100, "Insufficient result buffer size for app stereo depth"},
    {KP_FW_APP_STEREO_DEPTH_INSUFFICIENT_INPUT_IMAGE_10101, "Insufficient input image number for app stereo depth"},
    {KP_FW_APP_RGBD_SEG_INSUFFICIENT_RESULT_BUFFER_SIZE_10200, "Insufficient result buffer size for app RGBD seg"},
    {KP_FW_APP_RGBD_SEG_INSUFFICIENT_INPUT_IMAGE_10201, "Insufficient input image number for app RGBD seg"},
    {KP_FW_APP_RGBD_TRIPLE_CAM_SEG_INSUFFICIENT_RESULT_BUFFER_SIZE_10300, "Insufficient result buffer size for app RGBD triple camera seg"},
    {KP_FW_APP_RGBD_TRIPLE_CAM_SEG_INSUFFICIENT_INPUT_IMAGE_10301, "Insufficient input image number for app RGBD triple camera seg"},
    {KP_FW_APP_RGBD_TRIPLE_CAM_SEG_INVALID_DEPTH_DIRECTION_10302, "Invalid depth direction enum for app RGBD triple camera seg"},
    {KP_FW_APP_RGBD_TRIPLE_CAM_INSUFFICIENT_RESULT_BUFFER_SIZE_10500, "Insufficient result buffer size for app RGBD triple camera"},
    {KP_FW_APP_RGBD_TRIPLE_CAM_INSUFFICIENT_INPUT_IMAGE_10501, "Insufficient input image number for app RGBD triple camera"},
    {KP_FW_APP_RGBD_TRIPLE_CAM_INVALID_DEPTH_DIRECTION_10502, "Invalid depth direction enum for app RGBD triple camera"},
};
