...
class MainActivity : FlutterActivity() {
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, CHANNEL).setMethodCallHandler {
            ...
            if (call.method == "initializeUsb") {
                ...
                val initResult = Bridge.registerNative()
                Log.d("MainActivity", "UsbHostBridge.registerNative() auto-called in setMethodCallHandler, result=$initResult")
    ...
    //     val initResult = UsbHostBridge.registerNative(usbHostBridge)
    //     Log.d("MainActivity", "UsbHostBridge.registerNative() auto-called in onCreate, result=$initResult")
    // }
    ...
    override fun onDestroy() {
        ...
        val cleanupResult = Bridge.cleanupNative()
